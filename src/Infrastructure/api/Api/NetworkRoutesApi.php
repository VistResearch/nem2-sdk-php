...
class NetworkRoutesApi
{
     ...
     * @return \Swagger\Client\Model\NetworkTypeDTO
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\NetworkTypeDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function getNetworkTypeWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\NetworkTypeDTO';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\NetworkTypeDTO',
